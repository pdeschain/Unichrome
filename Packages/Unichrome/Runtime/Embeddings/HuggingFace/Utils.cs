...
namespace SentenceSimilarityUtils
{
    public static class Utils
    {
        ...
        {
            TextAsset tokenizerJson = Resources.Load<TextAsset>("Model/tokenizer");
            TextAsset tokenizerConfigJson = Resources.Load<TextAsset>("Model/tokenizer_config");

            string tokenizerJsonContent = tokenizerJson.text;
            string tokenizerConfigJsonContent = tokenizerConfigJson.text;
        ...
        static Tuple<List<List<int>>, List<List<int>>, List<List<int>>> Tokenize(IList<string> candidates)
        {
        ...
        /// <returns></returns>
        public static Dictionary<string, Tensor> TokenizeInput(IList<string> sentences)
        {
            List<List<int>> TokenIds = new List<List<int>>();
            List<List<int>> AttentionMask = new List<List<int>>();
            List<List<int>> TokenTypeIds = new List<List<int>>();
